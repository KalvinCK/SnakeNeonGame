...
namespace MyGame
{
    ...
    public class BloomFirstStage
    {
	    ...
	    private Shader mDownsampleShader;
	    private Shader mUpsampleShader;

        private bool mKarisAverageOnDownsample = true;

        public BloomFirstStage(int NumBlomMips)
        {
            mDownsampleShader = new Shader("resources/shaders/bloom/bloom.vert", "resources/shaders/bloom/downscale.frag");
            mUpsampleShader = new Shader("resources/shaders/bloom/bloom.vert", "resources/shaders/bloom/upscale.frag");
