...
namespace MyGame
{
    public class ImGuiController : IDisposable
    {
        ...
        public ImGuiController(Vector2 size)
        {
            ...
            _windowSize = new Vector2i((int)size.X, (int)size.Y);
        ...
        private void RecreateFontDeviceTexture()
        {
            ...
            // GL.TexStorage2D(TextureTarget2d.Texture2D, mips, SizedInternalFormat.Srgb8Alpha8, width, height);
        ...
        private void SetPerFrameImGuiData(float deltaSeconds)
        {
            ...
            io.DisplaySize = new System.Numerics.Vector2(
                _windowSize.X / _scaleFactor.X,
                _windowSize.Y / _scaleFactor.Y);
