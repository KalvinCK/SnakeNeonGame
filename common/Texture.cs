...
namespace MyGame
{
    public class Texture : IDisposable 
    {
        ...
        public PixelInternalFormat PixelInternFormat = PixelInternalFormat.Rgba32f;
        ...
        private void Init(string path)
        {
            ...
            StbImage.stbi_set_flip_vertically_on_load(FlipUvs ? 1 : 0);
            using(Stream stream = File.OpenRead(path))
            {
                ...
                GL.TexImage2D(TextureTarget.Texture2D, 0, PixelInternFormat, 
                    image.Width, image.Height, 0, PixelFormat.Rgba, PixelType.Float, image.Data);
            }
